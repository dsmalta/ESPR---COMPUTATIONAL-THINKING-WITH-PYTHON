...
# Item 4
# Custo dos Blocos
custo_blocos = qtd_blocos_emendas * 3.45 # multiplicação da nova quanitdade de blocos pelo preço por bloco para acharmos o preço total
print(f"O valor total gasto com a compra de cada bloco é de R${custo_blocos}.")

# Item 5
# Custo da Mão de Obra
custo_mao_obra = 100 * area_muro
